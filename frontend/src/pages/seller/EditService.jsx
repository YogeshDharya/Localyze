  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch service
        const svcRes = await serviceService.getById(id);
        if (svcRes.success && svcRes.data) {
          ...
          setFormData({
            ...
            priceUnit: svc.priceUnit || 'fixed',
            categoryId: svc.categoryId ? svc.categoryId.toString() : '',
            address: svc.address || '',
            latitude: svc.latitude !== null && svc.latitude !== undefined ? svc.latitude.toString() : '',
            longitude: svc.longitude !== null && svc.longitude !== undefined ? svc.longitude.toString() : ''
          });
        } else {
